package com.chickfila.diceroller
...
import com.chickfila.diceroller.architecture.viewmodel.DiceViewModel
import com.chickfila.diceroller.ui.theme.DiceRollerTheme
...
fun DiceWithButtonAndImage(modifier: Modifier = Modifier) {
    ...
    Column(modifier = modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Button(
            onClick = {
                result = diceRepository.rollDice()
            },
        ) {
